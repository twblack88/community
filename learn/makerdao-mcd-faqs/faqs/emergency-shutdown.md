...
2. **Cooldown Period:** After Emergency Shutdown is activated, a time period is needed to allow any ongoing [collateral auctions](https://docs.makerdao.com/auctions/the-auctions-of-the-maker-protocol#collateral-auction-collateral-sale) to conclude. Once all collateral auctions finish, the system can calculate the distribution of collateral to remaining Dai in circulation.
3. **Dai owners claim collateral:** Each Dai holder can redeem their Dai directly for a fixed amount of collateral.
